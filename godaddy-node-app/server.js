...
function buildPrompt(payload) {
  ...
  return [
    ...
    "",
    "Use live web search. Prioritize AutoTrader Canada, CarGurus Canada, official dealer listings, and credible Canadian marketplace listings.",
    ...
    "Prefer same year, make, model, trim/package, drivetrain, local Ontario listings, and similar mileage.",
